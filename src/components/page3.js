  ...
  return (
    <>
      <div className="bg-white shadow-xl flex overflow-auto flex-col h-full w-full justify-start items-center p-2">
        ...
        <img src={floor1} className="rounded-xl border border-2" />
        <Title number={"2"} name={"2階平面図"} />
        <img src={floor2} className="rounded-xl border border-2" />
        <Title number={"3"} name={"3階平面図"} />
        <img src={floor3} className="rounded-xl border border-2" />
        <Title number={"4"} name={"断面図"} />
        <img src={danmen} className="rounded-xl border border-2" />
